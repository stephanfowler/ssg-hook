...
- Set a [Web hook]() on your GitHub repository that points to your ssg-hook server `http://example.com:8080/hooks/ssg/:branch`, where `:branch` is the branch you want to publish. Usually this is `gh-pages` or `master` for `*.github.com` / `*.github.io` repositories.
...
# Jekyll
sudo gem install ssg --version "0.12.0"
